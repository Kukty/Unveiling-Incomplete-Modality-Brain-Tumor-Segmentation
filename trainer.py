...
from utils.loss import levelsetLoss,gradientLoss2d
...
def train_epoch(model, loader, optimizer, scaler, epoch, loss_func, args):
    ...
    for idx, batch_data in enumerate(loader):
        ...
        with autocast(enabled=args.amp):
            ...
            if args.use_shasloss:
                loss_L = levelsetLoss()(logits, target)
                loss_A = gradientLoss2d()(logits) *0.001
                loss_LS = (loss_L + loss_A) * 0.000001
        if args.amp:
