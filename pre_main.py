...
from pre_trainer import run_training
...
parser.add_argument("--pretrained_model_name", default="pre_train_swinVit.pt", type=str, help="pretrained model name")
...
parser.add_argument(
    "--pretrained_dir",
    default="/root/SwimUNETR_miss/pretrained_models",
    type=str,
